<template>
  <div class="container mx-auto p-8">
    ...
    <div class="my-8">
      ...
      <button
        class="block border dark:border-gray-700 rounded-lg mx-auto px-6 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm cursor-pointer transition-colors duration-200"
        @click="showMore"
