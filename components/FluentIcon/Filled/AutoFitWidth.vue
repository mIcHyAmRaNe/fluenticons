<template>
  <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path :fill="fill" :fill-opacity="opacity" d="M3 18a1 1 0 1 0 2 0V6a1 1 0 0 0-2 0zm16 0a1 1 0 1 0 2 0V6a1 1 0 1 0-2 0zm-5.214-4.2-.085.097-.006.008a1 1 0 0 0 1.511 1.302l2.35-2.348c.274-.179.444-.504.444-.86s-.17-.681-.444-.86L15.2 8.785l-.098-.085-.008-.005a1 1 0 0 0-1.302.096l-.006.007-.085.098-.006.007a1 1 0 0 0 .097 1.302l.794.795h-3.19l-.022.002h-1.96l.801-.802.093-.11.006-.008a1 1 0 0 0-.01-1.177l-.005-.008-.091-.105-.117-.1-.008-.005a1 1 0 0 0-1.177.01l-.008.005-.098.084-2.36 2.359-.065.045-.007.006A1.03 1.03 0 0 0 6 12c0 .356.17.681.443.86L8.8 15.215l.098.085.008.005a1 1 0 0 0 1.399-1.399l-.006-.007-.085-.098-.8-.8h3.19l.022-.001h1.96z" />
  </svg>
</template>
