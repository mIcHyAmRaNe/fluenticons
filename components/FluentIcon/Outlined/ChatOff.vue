<template>
  <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path :fill="fill" :fill-opacity="opacity" d="M20.5 12c0 1.53-.404 2.966-1.112 4.206l1.094 1.094A9.95 9.95 0 0 0 22 12c0-5.523-4.477-10-10-10a9.95 9.95 0 0 0-5.3 1.518l1.094 1.094A8.5 8.5 0 0 1 20.5 12" />
  </svg>
</template>
